...
extern void *mono_aot_module_photonmob_iOS_info;
...
extern void *mono_aot_module_photonmob_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Particle_info;
...
{
	mono_aot_register_module (mono_aot_module_photonmob_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_photonmob_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Particle_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "photonmob.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
